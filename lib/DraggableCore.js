...
export default class DraggableCore extends React.Component<DraggableCoreProps, DraggableCoreState> {
  ...
  handleDragStart: EventHandler<MouseTouchEvent> = (e) => {
    ...
    if (e.type === 'touchstart' && !e.target.closest('.scrollable')) {) e.preventDefault();
    ...
    addEvent(ownerDocument, dragEventFor.move, this.handleDrag, { passive: false }); // passive false allows to cancel
